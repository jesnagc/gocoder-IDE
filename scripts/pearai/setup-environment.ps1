...
function Initialize-BaseFunctionality {
    ...
    Set-Location .\extensions\gocoder-extension
...
function Create-SymLink {
    Write-Host "`nCreating symbolic link 'extensions\pearai-ref' -> 'extensions\gocoder-extension\extensions\vscode'" -ForegroundColor White
...
$modulePath = Join-Path -Path $currentDir -ChildPath 'extensions\gocoder-extension'
